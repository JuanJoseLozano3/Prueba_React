...
const data = [
    {id:1, nombre: "Juan Jose Betancourt Lozano", cargo: "Desarrollador Frontend"},
    {id:2, nombre: "Nicolai Martín Pérez", cargo: "Desarrollador Jefe"},
    {id:3, nombre: "Yuli Nova", cargo: "Desarrollador Backend"},
    {id:4, nombre: "Carlos Mario Zamora Diaz", cargo: "Psicologo"},
    {id:5, nombre: "Jorge Sebastian Capera", cargo: "Tester"},
    {id:6, nombre: "Brayan Sneider Vargas", cargo: "Analitico"}
];
...
class Operario extends React.Component{
    ...
    render(){
        return (
            ...
            <Container>
                <br />
                <Button color= "primary" onClick={this.mostrarModalInsertar}>Crear nuevo empleado</Button>
                <br /><br />
                <Table>
                    <thead><tr><th>Id</th>
                    <th>Nombre</th>
                ...
                <Modal isOpen={this.state.modalEditar}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            <Label fro="Cargo">Cargo</Label>
                            <Input type="text" onChange={this.handleChange} value={this.state.form.cargo}/>
                        </FormGroup>
                    </ModalBody>
                    <ModalFooter>
