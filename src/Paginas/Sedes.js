...
const data = [
    {id:1, nombre: "Sede principal", lugar: "Bogota"},
];
...
class Sedes extends React.Component{
    ...
    editar=(dato)=>{
        ...
        lista.map((registro)=>{
            if(dato.id===registro.id){
                ...
                lista[contador].lugar=dato.lugar;
            }
            contador++;
        });
    ...
    render(){
        return (
            ...
            <Container>
                <br />
                <Button color= "primary" onClick={this.mostrarModalInsertar}>Crear nueva sede</Button>
                <br /><br />
                <Table>
                    <thead><tr><th>Id</th>
                    <th>Nombre</th>
                ...
                <Modal isOpen={this.state.modalEditar}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            <Label fro="Cargo">Lugar</Label>
                            <Input type="text" onChange={this.handleChange} value={this.state.form.lugar}/>
                        </FormGroup>
                    </ModalBody>
                    <ModalFooter>
