...
const data = [
    {id:1, nombre: "Edna Lozano", enfermedad: "COVID-19"},
];

class Enfermos extends React.Component{
    ...
    editar=(dato)=>{
        ...
        lista.map((registro)=>{
            if(dato.id===registro.id){
                ...
                lista[contador].enfermedad=dato.enfermedad;
            }
            contador++;
        });
    ...
    render(){
        return (
            <div className='enfermos'>
            <Container>
                <br />
                <Button color= "primary" onClick={this.mostrarModalInsertar}>Crear nuevo empleado enfermo</Button>
                <br /><br />
                <Table>
                    <thead><tr><th>Id</th>
                    <th>Nombre</th>
                ...
                <Modal isOpen={this.state.modalInsertar}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            <Label fro="Cargo">Enfermedad</Label>
                ...
                <Modal isOpen={this.state.modalEditar}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            <Label fro="Cargo">Enfermedad</Label>
                            <Input type="text" onChange={this.handleChange} value={this.state.form.enfermedad}/>
                        </FormGroup>
                    </ModalBody>
                    <ModalFooter>
